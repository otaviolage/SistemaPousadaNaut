...
public class Produtos extends javax.swing.JPanel {
    ...
    private static Produtos myInstance;

    public static Produtos getInstance() {
        if (myInstance == null) {
            myInstance = new Produtos();
        }
        return myInstance;
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("CPF HOSPEDE");

        jLabel11.setText("CÓDIGO PRODUTO");

        jLabel12.setText("DATA CONSUMO");

        jLabel13.setText("SITUAÇÃO PAGAMENTO");
        ...
        jLabel5.setText("DATA CONSUMO");

        jLabel6.setText("SITUAÇÃO PAGAMENTO");
